        ...
        <div class="col-xl-12">
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <span class="active"><?php echo isset($_GET['id']) ? "Edit text" : "Add text" ?></span>
                    </li>
                </ol>
            </nav>
            <?php
            ...
            <main>
                ...
                <form id="form-addtext" class="add-form" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php if (isset($text_id)) {
                                                                echo $text_id;
                                                            } ?>">
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="text" id="title" name="title" class="form-control"
                                ...
                                autofocus required value="<?php if (isset($text_title)) {
                                                                echo $text_title;
                                                            } ?>">
                        </div>
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="text" id="author" name="author" class="form-control"
                                ...
                                value="<?php if (isset($text_author)) {
                                            echo $text_author;
                                        } ?>">
                        </div>
                    </div>

...
<div class="modal fade" id="reader-settings-modal" data-keyboard="true" tabindex="-1"
    aria-labelledby="reader-settings-modal-label" aria-modal="true" role="dialog">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <select name="fontsize" id="fontsize" class="form-control form-select" autocomplete="off">
                                <option value="1" <?php echo $font_size == '1' ? $sel : ''; ?>>Default
                                </option>
                                <option value="1.2" <?php echo $font_size == '1.2' ? $sel : ''; ?>>Medium
                                </option>
                                <option value="1.4" <?php echo $font_size == '1.4' ? $sel : ''; ?>>Large
                                </option>
                                <option value="1.6" <?php echo $font_size == '1.6' ? $sel : ''; ?>>Extra large
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 <?php echo $is_video_page ? 'd-none' : ''; ?> ">
                        ...
                        <div>
                            <select name="lineheight" id="lineheight" class="form-control form-select"
                                autocomplete="off">
                                <option value="1.5" <?php echo $line_height == '1.5' ? $sel : ''; ?>>Default
                                </option>
                                <option value="1.8" <?php echo $line_height == '1.8' ? $sel : ''; ?>>Relaxed
                                </option>
                                <option value="2" <?php echo $line_height == '2' ? $sel : ''; ?>>Wide</option>
                                <option value="2.4" <?php echo $line_height == '2.4' ? $sel : ''; ?>>Extra wide
                                </option>
                            </select>
                        </div>
                    </div>
...
<script defer src="/js/showreadersettingsmodal.js"></script>

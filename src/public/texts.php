...
<div class="container mtb d-flex flex-grow-1 flex-column">
    <div class="row">
        <div class="col-sm-12">
            ...
            <main>
                <?php require_once PUBLIC_PATH . 'activitymonitor.php'; ?>

                <div class="row flex">
                    <div class="col-sm-12">
                        <form id="texts-filter-form" class="form-flex-row" method="get">
                            <div id="search-wrapper-div" class="input-group mb-3">
                                ...
                                <div id="filter-dropdown" class="dropdown-menu">
                                    ...
                                    <a id="show_archived"
                                        class="dropdown-item sa <?= $show_archived ? 'active' : '' ?>">
                                        Archived
                                    </a>
                                    <div role="separator" class="dropdown-divider"></div>
                ...
                <div id="texts-list-container" class="position-relative">
                    <div id="texts-loader" class="text-center py-5 d-none">
...
<?php
require_once 'achievementsmodal.php';

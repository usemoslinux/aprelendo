    ...
    */
    protected function print_content(): string {
        ...
        for ($i=0; $i < sizeof($this->rows); $i++) { 
            ...
            if ($this->has_chkbox) {
                $html .= "<tr><td class='col-checkbox'><div><input id='row-$text_id' class='form-check-input chkbox-selrow' type='checkbox' aria-label='Select row' data-idText='$text_id'><label class='form-check-label' for='row-$text_id'></label></div></td>";
            } else {

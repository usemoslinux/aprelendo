...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/401-min.css">
...
<body>
    <main>
        <div class="page-wrap">
            <h1>401</h1>
            <h2>unauthorized</h2>
            <p>You tried to access a protected resource without providing proper authentication credentials.</p>
            <p><a href="/">home</a></p>
        </div>
    </main>
</body>

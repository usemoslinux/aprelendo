        ...
        <div class="col-xs-12">
            ...
            <div id="more_content" class="row flex">
                <div class="col-xs-12">
                    ...
                    <p>Cookies can be "persistent" (they expire on a specified date, usually remote in time) or "session" wise (they expire when you leave a website or after a short while).</p>
                    <br>
                    <h4>How <span class="bg-danger">My Company</span> uses cookies</h4>
                    ...
                    <p>Unlike most websites, we don't use cookies to provide analytics, to store your preferences, to enable advertisements delivery or including behavioral advertising.</p>
                    ...
                    <p>We do not use third-party cookies to report usage statistics of the Service, deliver advertisements on and through the Service, and so on.</p>
                    <br>
                    ...
                    <p>Please note, however, that if you delete cookies or refuse to accept them, you might not be able to use
                        all of the features we offer and some of our pages might not display properly.</p>
                    <br>

    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <main>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="alert alert-info"><span class="fas fa-info-circle"></span> All YouTube videos you add to Aprelendo will be shared with the rest of our community. You will find them in the "<a href="/sharedtexts">shared texts</a>" section.</div>

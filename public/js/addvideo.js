    ...
    */
    ...
    $('#btn-fetch').on('click', function () {
        ...
        if (video_id != '') {
            ...
            .done(function (data) {
                if(typeof data != 'undefined') {
                    if (typeof data.error_msg != 'undefined') {
                        ...
                        if (data.text == '') {
                            $('#text').val('');
                            showMessage('This video does not include valid audio transcripts. Please make sure to use <a href="https://www.youtube.com/results?sp=EgIoAQ%253D%253D&search_query=yoursearchterms" target="_blank" rel="noopener noreferrer">videos that include transcripts</a> in the language your are learning and that are not auto-generated by Google.', 'alert-danger');
                        } else {
                            $('#text').val(data.text);    
                        }
                    }
            ...
            .fail(function (xhr, ajaxOptions, thrownError) {
                showMessage('Oops! There was an unexpected error trying to get that video. Please try again later.', 'alert-danger');
            })
            .always(function() {

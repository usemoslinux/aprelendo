                    ...
                    if (typeof data != "undefined") {
                        if (typeof data.error_msg != "undefined") {
                            ...
                            if (data.text == "") {
                                $("#text").val("");
                                showMessage(
                                    'This video does not include valid subtitles. Please make sure to use ' +
                                    '<a class="alert-link" href="https://www.youtube.com/results?sp=EgIoAQ%253D%253D' +
                                    '&search_query=yoursearchterms" target="_blank" rel="noopener noreferrer">videos ' +
                                    'that include subtitles</a> in the language your are learning and that are not ' +

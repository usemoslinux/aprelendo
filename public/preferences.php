                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div id="help-learning-mode" class="collapse small">
                                ...
                                <ol>
                                    <li>First read (skimming and general comprehension of what the text is about) + listening (only if audio is available).</li>
                                    <li>Second read (to acquire a deeper understanding of the text) + opportunity to look up words in the dictionary or use the translator.</li>

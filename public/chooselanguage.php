...
?>
  ...
  <!-- *****************************************************************************************************************
	 HEADERWRAP
	 ***************************************************************************************************************** -->
  <div id="headerwrap" class="headerwrap nice-wallpaper-2">
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2 inverted-colors">
          ...
          <br/>
          <h3>Select the language you want to learn to register and start learning.</h3>
          <br/>
          <br/>
          <br/>
          <br/>

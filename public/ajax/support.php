...
try {
    if (isset($_POST['name'])
        ...
        if (strlen($name) > 100 || strlen($to) > 100 || strlen($message) > 5000) {
            throw new \Exception('You have exceeded the allowed length for one or more of the fields. '
        ...
        // it's important to include that last double \r\n in $message, otherwise email won't be well formed.
        // This is true especially because Content-Type:text/plain

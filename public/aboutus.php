            ...
            <div class="row vertical-align-center">
                <div class="col-sm-9">
                    <section>
                        ...
                        <p>I have always been intrigued by how people can become fluent in a second language. If you think about it, we all learned our native language without problems. So, <strong>why is it so difficult to learn additional languages?</strong> Well, we learned our native language by using it in an immersive environment (at home, at school, on the street, with friends, etc.), while we generally try to study other languages in a very limited and sporadic way. We think that approaching the task in a more "rational" and "methodical" fashion will make things easier, but on the contrary this is rarely effective. You probably speak your native language without knowing all its rules by heart, but you still speak it well. In contrast, when studying other languages, you spend hours analyzing rules or different meanings of some words, but you can't even express yourself well or engage in conversation.</p>
                        <p>It seems evident that <strong>there is something wrong with the way foreign languages are taught in academic institutions</strong> around the world. Aprelendo is my small contribution to change that situation. Also, it allowed me to combine two of my biggest passions: computer science and languages.</p>
                    </section>
                </div>

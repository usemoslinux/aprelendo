        ...
        <div class="col-xs-12">
            ...
            <div class="row flex simple-text">
                <div class="col-xs-12">
                    ...
                    <h5>Desktops</h5>
                    <p>Simply go to the web page you would like to add to you library and click on LangX's bookmarklet. It's
                        as easy as it gets.</p>
                    <h5>Mobile devices</h5>
                    <p>Go to the web page you would like to add to you library, tap on the URL bar and start to write "LangX".
                        Choose LangX's bookmarklet and let the magic happen.</p>
                    <p>In both cases, you'll be redirected to LangX so that you can include audio and do other changes to the

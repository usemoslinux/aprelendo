                ...
                <div class="col-xs-12">
                    ...
                    <ul>
                        ...
                        The following have been reported not to work: <a href="https://www.oxfordlearnersdictionaries.com"
                            target="_blank">Oxford Learners</a> (no modal support), <a href="https://en.oxforddictionaries.com"
                            target="_blank">Oxford compact</a> (no modal support), <a href="https://www.macmillandictionary.com"
                            target="_blank">Macmillan</a> (no modal support), <a href="https://www.ldoceonline.com"
                            target="_blank">Longman</a> (no modal support), <a href="https://www.collinsdictionary.com"
                            target="_blank">Collins</a> (no modal support), <a href="https://www.wordnik.com" target="_blank">Wordnik</a>
                        (no modal support).
                    </ul>
                    <br />
                    ...
                    <br />
                    <ul>
                        <small><i>Only English-&gt;Spanish dictionaries are listed, but you can easily make the
                                necessary changes to make them work in your native language. Just make sure to replace
                                "es" or "spanish" with the ISO code or name corresponding to your language.</i></small>
                        ...
                        <li>Cambridge dictionary: <a href="https://dictionary.cambridge.org/dictionary/english-spanish/%s"
                                target="_blank">https://dictionary.cambridge.org/dictionary/english-spanish/%s</a></li>
                        <li>Wordreference: <a href="https://www.wordreference.com/es/translation.asp?tranword=%s"
                                target="_blank">https://www.wordreference.com/es/translation.asp?tranword=%s</a></li>
                        <br />
                        The following have been reported not to work: <a href="https://mobile.reverso.net" target="_blank">Reverso</a>
                        (faulty https version),
                    </ul>
                    <h4>Spanish</h4>
                    <strong>Monolingual dictionaries</strong>
                    <ul>

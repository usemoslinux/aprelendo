            ...
            <main>
                <div class="row flex simple-text">
                    <div class="col-sm-12">
                        <section>
                            <h4>Fluency</h4>
                            <p>Language proficiency can be grouped into three dimensions of academic literacy: linguistic, 
                                cognitive, and sociocultural. In addition, there are <strong>four language domains</strong>: 
                                listening, speaking, reading, and writing. A person must be knowledgable in each of these 
                                domains in order to be language proficient.</p>
                            <p>During the process of learning a second language, it may seem logical to segment your
                                ...
                                (speaking & writing) ones or, conversely, that improving your oral skills is easier or even more 
                                important than mastering the written word. However, this depends on many factors, like the complexity 
                                of the language and its grammar, in what context you are thinking of using this language,
                                or how much this language resembles your mother tongue or some other language you've already 
                                mastered. Truth is, none of these domains is more important than the other, as all are equally 
                                required to be proficient in a language.</p>
                            <p>In fact, all these domains are so intrinsically interconnected that <strong>it is better to study 
                                them together</strong>. So, how do you achieve this objective?</p>
                            <br>
                            ...
                            <p>There are different ways to achieve language immersion: living abroad, dating a foreign
                                ...
                                latter.</p>
                            <p>Regarding <strong>online tools</strong>, there is a catch. Although many are more or less immersive,
                                they are not complete, since they focus on one of the dimensions of the language you are
                                trying to learn. For example, language learning platforms that allow you to hire
                        ...
                        <section>
                            ...
                            <ol>
                                <li>Read <strong>short texts</strong> (the length of a newspaper article or a short
                                    ...
                                    text. Also, make sure it is at <strong>your level or slightly above it</strong>.</li>
                                ...
                                <li><strong>Search</strong> the meaning of words and phrases you don't understand and
                                    add them to your learning stack</li>
                                <li><strong>Highlight</strong> these words every time you encounter them, as a way to
                                    check if you understand their meaning in each particular context.</li>
                                ...
                                <li>Read the text out loud, trying to imitate the recording that is being played.
                                    ...
                                    constructed. Eventually, it will become second nature.</li>
                                <li>Finally, in the <strong>dictation phase</strong>, play the audio again and try to
                                    write the words that you had previously marked as difficult.</li>
                            </ol>
                        </section>
                        <br>
                        <section>
                        ...
                        <section>
                            ...
                            <p>Our method has proven to be very beneficial, particularly for those who are on a learning
                                ...
                                initial vocabulary is very limited and due to the fact that there are not many curated texts 
                                adapted to their level freely available online.</p>
